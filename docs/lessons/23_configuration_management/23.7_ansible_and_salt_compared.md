...
!!! abstract "What you will learn"
    - Explain where **23.7 Ansible and Salt Compared ⚔️** fits in day-to-day Linux operations.
...
- How would you explain section 23.7 to a teammate during an incident handoff?
