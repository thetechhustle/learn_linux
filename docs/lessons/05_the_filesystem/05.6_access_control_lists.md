...
!!! abstract "What you will learn"
    - Explain where **05.6 Access Control Lists (ACLs) 🛡** fits in day-to-day Linux operations.
...
- How would you explain section 5.6 to a teammate during an incident handoff?
