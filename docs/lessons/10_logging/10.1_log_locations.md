...
!!! abstract "What you will learn"
    - Explain where **10.1 Log Locations 🗂️📍** fits in day-to-day Linux operations.
...
- How would you explain section 10.1 to a teammate during an incident handoff?
...
- `/var/log/apt`: This directory keeps track of package installations and removals via package managers like `apt` and lower-level package tools. 📦
